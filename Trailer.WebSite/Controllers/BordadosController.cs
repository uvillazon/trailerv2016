...
namespace Trailer.WebSite.Controllers
{
    public class BordadosController : Controller
    {
        ...
        public ActionResult GetAllBordados(int page, int start, int limit, string sort, string dir, long _dc, string callback, string condicion = null, string codigo = null)
        {
            ...
            var service = new BordadosService();
            var jsondata = service.GetAllBordados(filter, codigo);
