<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrdenProduccionDetalles.aspx.cs" Inherits="Trailer.WebSite.Informes.OrdenProduccionDetalles" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="800px" 
        ...
        <LocalReport ReportPath="Informes\ReporteDetalleOP.rdlc" 
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        SelectMethod="getAllOrdenProduccion" 
        TypeName="Trailer.WebSite.Infrastructure.Reportes">
        <SelectParameters>
