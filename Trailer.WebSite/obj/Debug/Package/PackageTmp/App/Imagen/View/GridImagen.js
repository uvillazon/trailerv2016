var columns = [
   ...
   { header: "Imagen", flex: 1, renderer: renderIcon, dataIndex: 'ID', sortable: true },
...
function renderIcon(val, metaData, record) {
    //  alert(record.data.ID)
    if (record.data.EXTENSION == "application/pdf") {
        return '<img src="../Content/Iconos/pdf_icon.png" />';
    }
    else {
        return '<img src="../Imagen/GetImage/?id=' + val + '&tamano=150"/>';
    }
}
...
Ext.define("App.Imagen.View.GridImagen", {
    ...
    onView: function () {
        ...
        '></iframe>'
                ...
                me.winView.add([{ html: '<object width="100%" height="100%" data="../Imagen/GetImage/?id=' + pdf + '&tamano=900"></object>'}]);
                me.winView.show();
            }
    ...
    onDelete: function () {
        var me = this;
        var direccion = "../Imagen/EliminarImagen";
