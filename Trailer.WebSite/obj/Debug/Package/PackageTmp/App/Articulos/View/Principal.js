Ext.define("App.Articulos.View.Principal", {
    ...
    frame: true,
    layout: 'border',
    title : "Adminsitracion de Articulos",
    defaults: {
        split: true
    },
    initComponent: function () {
        ...
        me.form_Emp = Ext.create('App.Articulos.View.FormArticulo', {
            width: '40%',
            height: '100%',
            region: 'center',
        });
        me.grid = Ext.create("App.Articulos.View.GridArticulos", {
            region: 'west',
            width: '50%',
            height: '100%',
            form : me.form_Emp
