Ext.define("App.Empresas.View.GridEmpresas", {
    ...
    initComponent: function () {
        ...
        this.store = Ext.create('App.Empresas.Store.Empresas');
        this.store.load();
        this.columns = [
        ...
        //////////
        me.txt_busqueda = Ext.create("App.Utils.Componente.TextFieldBase", { fieldLabel: "Buscar Empresa", width: 200, labelWidth: 80 })
        me.button = Ext.create('Ext.Button', {
            //text: 'Click me',
            text: 'Buscar',
            pressed: true,
            iconCls: 'zoom',
            tooltip: 'Buscar por Empresa',
            cls: 'botones',
            enableToggle: true,
            scope: this
            ...
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Guardar los cambios', function (btn) {
                ...
                if (btn == 'yes') {
                    ...
                    form.submit({
                        ...
                        url: host+'Empresas/CrearEmpresa',
        ...
        if (data != null) {
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Eliminar este Registro?', function (btn) {
                if (btn == 'yes') {
                    ...
                    Ext.Ajax.request({
                        url: host+'Empresas/EliminarEmpresa',
                        params: { ID_EMPRESA: data.get('ID_EMPRESA') },
