 ...
 */
Ext.define("App.Config.ux.excelFormatter.Workbook", {
  ...
  addWorksheet: function(store, config) {
    var worksheet = new App.Config.ux.excelFormatter.Worksheet(store, config);
  ...
  addStyle: function(config) {
    var style = new App.Config.ux.excelFormatter.Style(config || {});
