Ext.define("App.Productos.View.Principal", {
    ...
    frame: true,
    layout: 'border',
    title : "Adminsitracion de Productos Terminados",
    defaults: {
        split: true
    },
    initComponent: function () {
        ...
        me.form_Emp = Ext.create('App.Productos.View.FormProducto', {
            width: '40%',
            height: '100%',
            region: 'center',
        });
        me.grid = Ext.create("App.Productos.View.GridProductos", {
            region: 'west',
            width: '50%',
            height: '100%',
            form : me.form_Emp
