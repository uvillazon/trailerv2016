Ext.define("App.Articulos.View.GridArticulos", {
    ...
    initComponent: function () {
        ...
        this.store = Ext.create('App.Articulos.Store.Articulos');
        this.store.load();
        this.columns = [
            { xtype: 'rownumberer', width: 30, sortable: false },
            { header: "Articulo", width: 100, sortable: true, dataIndex: 'NOMBRE' },
            { header: "Codigo", width: 100, sortable: true, dataIndex: 'CODIGO' },
            { header: "Categoria", width: 100, sortable: true, dataIndex: 'CATEGORIA' },
            { header: "Medida", width: 100, sortable: true, dataIndex: 'MEDIDA' },
            { header: "Tela", width: 100, sortable: true, dataIndex: 'TELA' },
            { header: "Estado", width: 100, sortable: true, dataIndex: 'ESTADO' },
            { header: "Descripcion", width: 100, sortable: true, dataIndex: 'DESCRIPCION' },
            
        ];
        //////////
        me.txt_busqueda = Ext.create("App.Utils.Componente.TextFieldBase", { fieldLabel: "Buscar Articulo", width: 200, labelWidth: 80 })
        me.button = Ext.create('Ext.Button', {
            //text: 'Click me',
            text: 'Buscar',
            pressed: true,
            iconCls: 'zoom',
            tooltip: 'Buscar por Articulos',
            cls: 'botones',
            enableToggle: true,
            scope: this
            ...
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Guardar los cambios', function (btn) {
                ...
                if (btn == 'yes') {
                    ...
                    form.submit({
                        ...
                        url: host+'Articulos/CrearArticulo',
        ...
        if (data != null) {
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Eliminar este Registro?', function (btn) {
                if (btn == 'yes') {
                    ...
                    Ext.Ajax.request({
                        url: host+'Articulos/EliminarArticulo',
