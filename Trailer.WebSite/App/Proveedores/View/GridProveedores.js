Ext.define("App.Proveedores.View.GridProveedores", {
    ...
    initComponent: function () {
        ...
        this.columns = [
            ...
            { header: "Web", width: 100, sortable: true, dataIndex: 'WEB' },
            { header: "Descripcion", width: 100, sortable: true, dataIndex: 'DESCRIPCION' },
            { header: "NIT", width: 100, sortable: true, dataIndex: 'NIT' },
            { header: "Representante", width: 100, sortable: true, dataIndex: 'REPRESENTANTE' }
        ];
        //////////
        me.txt_busqueda = Ext.create("App.Utils.Componente.TextFieldBase", { fieldLabel: "Buscar Proveedor", width: 200, labelWidth: 80 })
            ...
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Guardar los cambios', function (btn) {
                ...
                if (btn == 'yes') {
                    ...
                    form.submit({
                        ...
                        url: host+'Proveedores/CrearProveedor',
        ...
        if (data != null) {
            Ext.MessageBox.confirm('Confirmacion?', 'Esta Seguro de Eliminar este Registro?', function (btn) {
                if (btn == 'yes') {
                    ...
                    Ext.Ajax.request({
                        url: host+'Proveedores/EliminarProveedor',
                        params: { ID_PROVEEDOR: data.get('ID_PROVEEDOR') },
