...
function SaldoFactura(v, record) {
    return record.data.TOTAL - record.data.IMPORTE_FACTURADO;
}
Ext.define("App.OrdenesProduccion.Model.OrdenesProduccion", {
    ...
    fields: [
        ...
        { name: 'IMPORTE_FACTURADO', type: 'float' },
        { name: 'SALDO_FACTURADO', convert: SaldoFactura },
