Ext.define("App.OrdenesProduccion.View.GridDetalle", {
    extend: "Ext.grid.Panel",
    title: 'Detalle Orden Produccion  ',
    width: 480,
    collapsible: true,
    split: true,
    height: '100%',
//    collapsible: true,
    ...
    initComponent: function () {
        ...
        else if (me.opcion == 'DetalleOp'){
            me.CargarComponentesDetalleOp();
        }
        else if(me.opcion == 'HojaCalculo'){
            me.CargarComponentesHojaCalculo();
        }
        else{
            alert("otra opcion");
        }
    ...
    CargarComponentesHojaCalculo : function (){
        var me = this;
        ...
        me.txt_total_cant = Ext.create("App.Utils.Componente.TextFieldBase", {
         ...
         me.Generar = Ext.create('Ext.Button', {
            text: 'Generar Hoja Calculo',
            tooltip: 'Generar Hoja de Calculo',
            iconCls: 'add',
            cls: 'botones',
            scope: this
