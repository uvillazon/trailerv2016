...
//      //      margin: '10'
//        });
         me.cbx_tela = Ext.create("App.Config.Componente.ComboBase", {
            fieldLabel: 'Buscar Tela',
            name : 'TELA',
            store: me.store_telas,
            displayField: 'VALOR',
            valueField: 'VALOR',
...
//        });
        ...
        me.store_articulos = Ext.create('App.Articulos.Store.Articulos');
...
//      //      margin: '10'
//        });
         me.cbx_articulos = Ext.create("App.Config.Componente.ComboAutoBase", {
      ...
      //      margin: '10'
        ...
        },
        {
           ...
           items: [me.cbx_articulos, me.cbx_tela, me.cbx_color,
