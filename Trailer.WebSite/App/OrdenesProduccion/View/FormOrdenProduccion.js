Ext.define("App.OrdenesProduccion.View.FormOrdenProduccion", {
    ...
    initComponent: function () {
        ...
        this.txt_id_cliente = Ext.create("App.Utils.Componente.TextFieldBase", {
